...
<head>
    ...
    <title>DevsAI - Générateur de Fiche Technique Automatique</title>
    <!-- Fonts -->
...
<body class="bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div class="container mx-auto px-4 py-16">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <a href="{{ url('/') }}" class="inline-block bg-white text-blue-700 font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-blue-50 transition duration-300">
                    Commencer l'analyse
                </a>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 py-16 text-center">
        ...
        <a href="{{ url('/') }}" class="inline-block bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300">
    ...
    <footer class="bg-gray-800 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; {{ date('Y') }} DevsAI - Générateur de Fiche Technique Automatique</p>
        </div>
    </footer>
</body>
</html>
